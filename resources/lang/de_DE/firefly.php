...
return [
    ...
    'previous_year'                                       => 'Letztes Jahr (:year)',
    ...
    'pref_anonymous'                                      => 'Ausgeblendete Beträge',
    'pref_anonymous_help'                                 => 'Aus Gründen der Privatsphäre und Anonymität können Sie Firefly III so einstellen, dass alle Beträge ausgeblendet werden. Dadurch werden die Beträge in den Bearbeitungsfeldern nicht ausgeblendet, alle anderen jedoch schon. Sie können diese Einstellung auch über das kleine Augen-Symbol (👁) in der oberen Leiste umschalten.',
    'pref_anonymous_label'                                => 'Beträge ausblenden',
    ...
    'anonymous_warning_on'                                => 'Aus Datenschutzgründen werden alle Beträge nun als „Null“ angezeigt. Achtung: In den Texteingabefeldern werden möglicherweise weiterhin die ursprünglichen Beträge angezeigt!',
    'anonymous_warning_off'                               => 'Die Beträge werden erneut angezeigt. Bitte achten Sie auf Ihre Umgebung.',
    ...
    'no_new_release_available'                            => 'Es ist keine neuere Version verfügbar. Sie sind bereits auf dem neuesten Stand.',
    ...
    'applied_rule_group_selection'                        => '{0} In Ihrer Auswahl wurden keine Buchungen durch Regeln der Regelgruppe „:title“ geändert.|[1] In Ihrer Auswahl wurde eine Buchung durch Regeln der Regelgruppe „:title“ geändert.|[2,*] :count Buchungen in Ihrer Auswahl wurden durch Regeln der Regelgruppe „:title“ geändert.',
    'rule_run_after_creation'                             => 'Wenn Sie dieses Kästchen ankreuzen, haben Sie die Möglichkeit, die Regel nach ihrer Erstellung auszuführen.',
    'rule_run_after_edit'                                 => 'Wenn Sie dieses Kästchen ankreuzen, haben Sie die Möglichkeit, die Regel nach ihrer Aktualisierung auszuführen.',
    ...
    'config_security'                                     => 'Sicherheitskonfiguration',
    'config_features'                                     => 'Aktivierte Funktionen',
    'config_tech'                                         => 'Technische Funktionen',
    'config_external_connections'                         => 'Datenschutzrelevante Einstellungen (Verbindung zum Internet)',

    'setting_enable_exchange_rates'                       => 'Wechselkurse aktivieren',
    'setting_enable_exchange_rates_explain'               => 'Firefly III kann für Sie Wechselkurse berechnen.',
    'setting_use_running_balance'                         => 'Spalte „Zwischensaldo“ und Daten verwenden',
    'setting_use_running_balance_explain'                 => 'Firefly III kann das aktuelle Zwischensaldo für Sie berechnen und an verschiedenen Stellen anzeigen. Diese Funktion befindet sich noch in der Testphase und ist daher standardmäßig deaktiviert. Möglicherweise müssen Sie Ihren Container neu starten oder den Startbefehl manuell ausführen (siehe Dokumentation).',
    'setting_enable_external_map'                         => 'Externen Kartendienst verwenden',
    'setting_enable_external_map_explain'                 => 'Firefly III verwendet einen externen Dienst zur Anzeige von Standorten. Sind Sie damit einverstanden?',
    'setting_enable_external_rates'                       => 'Wechselkurse aus dem Internet herunterladen',
    'setting_enable_external_rates_explain'               => 'Firefly III kann Wechselkurse für die integrierten Währungen herunterladen. Dazu ist es erforderlich, dass der Cron-Job funktioniert.',
    'setting_allow_webhooks'                              => 'Webhooks erlauben',
    'setting_allow_webhooks_explain'                      => 'Firefly III das Auslösen von Webhooks erlauben?',
    'setting_valid_url_protocols'                         => 'Zulässige URL-Protokolle',
    'setting_valid_url_protocols_explain'                 => 'Firefly III akzeptiert nur URLs mit Standardprotokollen wie https und ftp usw. Wenn Sie technisch versiert sind, möchten Sie vielleicht auch andere Protokolle zulassen.',
    'setting_enable_batch_processing'                     => 'Stapelverarbeitung aktivieren',
    'setting_enable_batch_processing_explain'             => 'Die Stapelverarbeitung ist eine relativ neue Funktion von Firefly III, mit der eine Reihe neuer Buchungen (auch als Stapel bezeichnet) erst bei Übermittlung der letzten Buchung und nicht bei Übermittlung jeder einzelnen Buchung verarbeitet werden. Dadurch wird der Datenimport beschleunigt, aber auch Regeln werden bis zum Ende übersprungen. Da es sich um eine experimentelle Funktion handelt, ist sie standardmäßig deaktiviert.',
    ...
    // audit log entries
    'incomplete_ale'                                      => 'Nicht alle Ereignisse werden als Protokoll-Einträge aufgezeichnet.',
    ...
    'ale_action_update_foreign_amount'                    => 'Aktualisierter Fremdbetrag',
