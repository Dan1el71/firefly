...
return [
    ...
    'piggy-banks_create_date'                                 => 'Puede establecer una fecha objetivo o una fecha limite para su alcancía.',
    ...
    // bill index
    'bills_index_rules'                                       => 'Aquí verás qué reglas se aplicarán si se selecciona esta factura',
    'bills_index_paid_in_period'                              => 'Este campo indica cuando la suscripción fue pagada.',
    'bills_index_expected_in_period'                          => 'Este campo indica para cada suscripción si y cuándo se espera la siguiente.',

    'subscriptions_index_rules'                               => 'Aquí verás qué reglas se aplicarán si se selecciona esta factura',
    'subscriptions_index_paid_in_period'                      => 'Este campo indica cuando la suscripción fue pagada por última vez.',
    'subscriptions_index_expected_in_period'                  => 'Este campo indica para cada factura, si y cuándo se espera que llegue la próxima factura.',
    ...
    'bills_show_billChart'                                    => 'Este gráfico muestra las transacciones vinculadas con esta suscripción.',
    'subscriptions_show_billInfo'                             => 'Esta tabla muestra información general sobre esta suscripción.',
    'subscriptions_show_billButtons'                          => 'Use este botón para volver a escanear transacciones viejas, para que coincidan con esta factura.',
    'subscriptions_show_billChart'                            => 'Este gráfico muestra las transacciones vinculadas con esta factura.',
    ...
    'bills_create_amount_min_holder'                          => 'Selecciona un importe mínimo y un importe máximo para esta suscripción.',
    'bills_create_repeat_freq_holder'                         => 'La mayoría de las suscripciones se repiten mensualmente, sin embargo, puedes establecer otra frecuencia acá.',
    'bills_create_skip_holder'                                => 'Si una cuenta se repite cada 2 semanas, el campo "omitir" debe estar marcado como "1" para omitir una semana y generar el gasto cada 2.',
