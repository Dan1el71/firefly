...
return [
    ...
    'greeting'                                   => 'Pozdrav,',
    'closing'                                    => 'Bip-bip,',
    'signature'                                  => 'Firefly III robot za poštu',
    'footer_ps'                                  => 'PS: Ova poruka je poslata jer ju je automatski generisao zahtev sa IP adrese :ipAddress.',

    // admin test
    'admin_test_subject'                         => 'Test poruka sa tvoje instalacije Firefly III',
    'admin_test_body'                            => 'Ovo je test poruka od tvoje instalacije Firefly III. Poslata je na :email.',
    'admin_test_message'                         => 'This is a test message from your Firefly III instance over channel ":channel".',

    // invite
    'invitation_created_subject'                 => 'Pozivnica je kreirana',
    'invitation_created_body'                    => 'Administrator korisnik adrese e-pošte ":email" kreirao je korisnički poziv koji može da koristi svako ko je iza adrese ":invitee". Poziv će važiti 48 časova.',
    'invite_user_subject'                        => 'Pozvan si da kreiraš Firefly III nalog.',
    'invitation_introduction'                    => 'Pozvan si da kreiraš Firefly III nalog na lokaciji **:host**. Firefly III je privatni lični menadžer finansija sa sopstvenim hostingom. Koristi ga svako kul dete.',
    'invitation_invited_by'                      => 'Pozvao te je ":admin" i ta pozivnica je poslata na adresu ":invitee". To si ti, zar ne?',
    'invitation_url'                             => 'Poziv važi 48 časova i može se povratiti surfovanjem na [Firefly III](:url). Uživaj!',

    // new IP
    'login_from_new_ip'                          => 'Novo prijavljivanje na Firefly III',
    'slack_login_from_new_ip'                    => 'Novo prijavljivanje na Firefly III sa IP adrese :ip (:host)',
