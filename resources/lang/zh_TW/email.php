...
return [
    ...
    'admin_test_message'                         => '這是一個來自您Firefly III實體的測試訊息，頻道為：「:channel」。',
    ...
    'unknown_user_subject'                       => '有未知使用者嘗試登入',
    ...
    'failed_login_subject'                       => 'Firefly III偵測到嘗試登入失敗',
    ...
    'failed_login_warning'                       => '如果您有印象此IP 地址或登入紀錄，您可以無視此訊息。如果您沒有登入或不知道在發生什麼事，請您至個人資料頁面，確認您的密碼強度、更改密碼並登出所有其他登入階段。我們強烈建議您啟用多重驗證以保證資料安全！',
    ...
    'registered_help'                            => '幫助按鈕在畫面的右上方。如您需要協助請點選該按鈕！',
    ...
    'email_change_old'                           => '原始電子郵件：:email',
    'email_change_old_strong'                    => '原始e-mail為：**:email**',
    'email_change_new'                           => '新電子郵件：**:email**',
    ...
    'reset_pw_message'                           => '您將收到一封重置密碼指示信件。如果您確認為本人需要修改密碼，請依照信件指示操作。',
    ...
    'error_stacktrace'                           => '完整追蹤記錄如下，如果您認為這是一個Bug，請將此紀錄傳送至 <a href="mailto:james@firefly-iii.org?subject=I%20found%20a%20bug!">james@firefresy-iii.org</a>。我們將修正此Bug。',
    ...
    'error_stacktrace_below'                     => '完整的堆疊追蹤如下：',
    'error_headers'                              => '有關的HTTP頭欄位如下：',
    'error_post'                                 => '提交此的用戶:',

    // report new journals
    'new_journals_subject'                       => 'Firefly III 已建立了一項新的交易|Firefly III 已建立了 :count項新的交易',
    'new_journals_header'                        => 'Firefly III 已為您建立了一筆交易，您可以在您的 Firefly III 站台中查看：|Firefly III 已為您建立了:count筆交易，您可以在您的 Firefly III 站台中查看：',
    ...
    // bill warning
    'bill_warning_subject_end_date'              => '你的訂閱 ":name" 將於 :diff 日內到期',
    'bill_warning_subject_now_end_date'          => '你的訂閱 ":name" 將於今日到期',
    'bill_warning_subject_extension_date'        => '你的訂閱 ":name" 將於 :diff 日內延展或取消',
    'bill_warning_subject_now_extension_date'    => '你的訂閱 ":name" 將於今日延展或取消',
    ...
    'have_enabled_mfa'                           => '您的 Firefly III 帳號「:email」啟用了多階段認證。您後續登入時必須使用驗證程式才能登入。',
    'enabled_mfa_warning'                        => '如並非您本人啟用此功能，請立即聯絡您的管理員或確認Firefly III 說明書。',

    'disabled_mfa_subject'                       => '您已停用多重驗證登入！',
    ...
    'used_backup_code_warning'                   => '如並非您本人進行操作，請立即聯絡您的管理員或確認Firefly III 說明書。',
    ...
    'mfa_many_failed_subject'                    => '您已使用多重驗證登入失敗:count次！',
    ...
    'mfa_many_failed_attempts_warning'           => '如果並非您進行操作，請立即聯絡您的管理員或確認Firefly III 說明書。',
];
