...
return [
    ...
    'greeting'                                   => 'Komið sæl,',
    'closing'                                    => 'Bíp búp,',
    'signature'                                  => 'Tölvupóstsvélmenni Firefly III',
    'footer_ps'                                  => 'PS: Þessi skilaboð voru send vegna beiðni frá IP fangi :ipAddress.',

    // admin test
    'admin_test_subject'                         => 'Prufuskilaboð frá Firefly III uppsetningunni þinni',
    'admin_test_body'                            => 'Þetta eru prufuskilaboð frá Firefly III. Þau voru send til :email.',
    ...
    // new IP
    'login_from_new_ip'                          => 'Ný innskráning í Firefly III',
    'slack_login_from_new_ip'                    => 'New Firefly III login from IP :ip (:host)',
    'new_ip_body'                                => 'Firefly III nam nýja innskráningu á þinn reikning frá óþekktu IP fangi. Ef þú hefur ekki skráð þig inn frá neðangreindu IP fangi á seinustu 6 mánuðum mun Firefly III vara þig við.',
    'new_ip_warning'                             => 'Ef þú þekkir þetta IP fang eða auðkenni geturðu hundsað þessi skilaboð. Ef þú skráðir þig ekki inn eða hefur enga hugmynd um hvað þetta er, breyttu lykilorðinu þínu og skráðu þig út úr öllum öðrum setum. Þetta má gera í gegnum prófílsíðuna. Virkjaðu tveggja þrepa auðkenningu fyrst þú ert að þessu, öryggið á broddinn!',
    'ip_address'                                 => 'IP fang',
    'host_name'                                  => 'Hýsill',
    'date_time'                                  => 'Dagsetning + tími',
    'user_agent'                                 => 'Browser',

    // access token created
    'access_token_created_subject'               => 'Nýr auðkenningartóki var stofnaður',
    'access_token_created_body'                  => 'Einhver (vonandi þú) stofnaðir nýjan Firefly III aðganstóka að forritaskilum fyrir þinn notandaaðgang.',
    ...
    // registered
    'registered_subject'                         => 'Velkomin í Firefly III!',
    'registered_subject_admin'                   => 'A new user has registered',
    'admin_new_user_registered'                  => 'A new user has registered. User **:email** was given user ID #:id.',
    'registered_welcome'                         => 'Welcome to [Firefly III](:address). Your registration has made it, and this email is here to confirm it. Yay!',
    'registered_pw'                              => 'If you have forgotten your password already, please reset it using [the password reset tool](:address/password/reset).',
    'registered_help'                            => 'Það er hjálpartákn í efra hægra horni hverrar síðu. Ef þig vantar hjálp, smelltu á það!',
    'registered_closing'                         => 'Njótið!',
    'registered_firefly_iii_link'                => 'Firefly III:',
    'registered_pw_reset_link'                   => 'Endursetja lykilorð:',
    'registered_doc_link'                        => 'Leiðbeiningar:',

    // new version
    'new_version_email_subject'                  => 'A new Firefly III version is available',

    // email change
    'email_change_subject'                       => 'Firefly III netfangi þínu var breytt',
    'email_change_body_to_new'                   => 'Þú eða einhver með aðgang að Firefly III reikningnum þínum hefur breytt netfanginu þínu. Ef þú bjóst ekki við þessum skilaboðum, vinsamlegast hundsaðu þau og eyddu þeim.',
    'email_change_body_to_old'                   => 'You or somebody with access to your Firefly III account has changed your email address. If you did not expect this to happen, you **must** follow the "undo"-link below to protect your account!',
    'email_change_ignore'                        => 'Ef þú ollir þessum breytingum geturðu með öruggu móti hundsað þessi skilaboð.',
