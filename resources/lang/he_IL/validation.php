...
return [
    ...
    'source_equals_destination'       => 'חשבון המקור וחשבון היעד זהים.',
    'unique_account_number_for_user'  => 'נראה שמספר חשבון זה כבר נמצא בשימוש.',
    'unique_user_group_for_user'      => 'It looks like this administration title is already in use.',
    'unique_iban_for_user'            => 'נראה כאילו מספר IBAN זה כבר נמצא בשימוש.',
    'reconciled_forbidden_field'      => 'This transaction is already reconciled, you cannot change the ":field"',
    'deleted_user'                    => 'בשל מגבלות אבטחה, אתה לא יכול להרשם באמצעות כתובת דואר זו.',
    'rule_trigger_value'              => 'This value is invalid for the selected trigger.',
    'rule_action_expression'          => 'Invalid expression. :error',
    'rule_action_value'               => 'ערך זה אינו חוקי עבור הפעולה שנבחרה.',
    ...
    'all_accounts_equal'              => 'כל החשבונות בשדה זה חייבים להיות שווים.',
    ...
    'invalid_selection'               => 'הבחירה שלך אינה חוקית.',
    ...
    'at_least_one_transaction'        => 'צריך לפחות טרנזקציה אחת.',
    ...
    'unique_object_for_user'          => 'שם זה נמצא כבר בשימוש.',
