...
return [
    ...
    'invalid_account_type'            => 'Una guardiola només es pot vincular a comptes d\'actius i passius',
    'unique_currency_code'            => 'This currency code is already in use',
    'invalid_account_currency'        => 'Aquest compte no utilitza la moneda que has seleccionat',
    'current_amount_too_much'         => 'L\'import combinat a "current_amount" no pot superar "target_amount".',
    'filter_must_be_in'               => 'El filtre ":filter" ha de ser un dels següents: :values',
    'filter_not_string'               => 'S\'espera que el filtre ":filter" sigui una cadena de text',
    'bad_api_filter'                  => 'Aquesta API no suporta ":filter" com a filtre.',
    'nog_logged_in'                   => 'No has iniciat sessió.',
    ...
    'unique_user_group_for_user'      => 'Sembla que el número de compte ja està en ús.',
    ...
    'no_access_group'                 => 'L\'usuari no té accés a aquesta administració.',
    ...
    'generic_invalid'                 => 'Aquest valor no és vàlid.',
    'transaction_type_changed'        => 'Si canvieu el tipus de transacció, assegureu-vos que els comptes d\'origen/destí estiguin definits correctament.',
    ...
    'piggy_no_change_currency'        => 'Com que hi ha guardioles vinculades a aquest compte, no podeu canviar la moneda del compte.',
    ...
    'missing_with'                    => 'L\'atribut :no es pot combinar amb un altre camp.',
    ...
    'no_auth_user_group'              => 'Heu d\'iniciar la sessió per accedir a aquesta administració.',
    ...
    'existing_mfa_code'               => 'Introduïu un codi vàlid',
];
