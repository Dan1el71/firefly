...
return [
    ...
    'invalid_account_type'            => '저금통은 자산 계정과 채무에만 연결할 수 있습니다',
    ...
    'bad_type_source'                 => 'Firefly III는 이 출발지 계정에 기반한 거래 타입을 결정할 수 없습니다.',
    'bad_type_destination'            => 'Firefly III는 이 목적지 계정에 기반한 거래 타입을 결정할 수 없습니다.',
    ...
    'more_than_zero'                  => '금액은 0보다 커야 합니다.',
    'more_than_zero_correct'          => '금액은 0이거나 0보다 커야합니다.',
    'no_asset_account'                => '자산 계정이 아닙니다.',
    'date_or_time'                    => '유효한 날짜 또는 시간 값(ISO 8601) 이어야 합니다.',
    'source_equals_destination'       => '출발지 계정이 목적지 계정과 같습니다.',
    ...
    'reconciled_forbidden_field'      => '이 거래는 이미 조정되었습니다. ":field"를 수정할 수 없습니다.',
    ...
    'belongs_user'                    => '이 값은 존재하지 않는 오브젝트에 연결되어 있습니다.',
    'belongs_user_or_user_group'      => '이 값은 현재 재정관리에 존재하지 않는 오프젝트에 연결되어 있습니다.',
    ...
    'require_foreign_dest'            => '이 항목 값은 목적지 계정의 통화와 일치해야 합니다.',
    'require_foreign_src'             => '이 항목 값은 출발지 계정의 통화와 일치해야 합니다.',
    ...
    'scientific_notation'             => ':attribute는 과학적 표기법을 사용할 수 없습니다.',
    ...
    'withdrawal_source_need_data'     => '계속하려면 유효한 출발지 계정 ID 및/또는 유효한 출발지 계정 이름이 필요합니다.',
    'withdrawal_source_bad_data'      => '[a] ID ":id" 또는 이름 ":name"을 검색할 때 유효한 출발지 계정을 찾을 수 없습니다.',
    'withdrawal_dest_need_data'       => '[a] 계속하려면 유효한 목적지 계정 ID 및/또는 유효한 목적지 계정 이름이 필요합니다.',
    'withdrawal_dest_bad_data'        => 'ID ":id" 및 이름 ":name"(으)로 유효한 목적지 계정을 찾을 수 없습니다.',

    'withdrawal_dest_iban_exists'     => '목적지 계정의 IBAN이 이미 다른 자산 계정이나 부채에 사용되고 있어 출금 대상으로 사용할 수 없습니다',
    ...
    'generic_source_bad_data'         => '[e] ID ":id" 또는 이름 ":name"을 검색할 때 유효한 출발지 계정을 찾을 수 없습니다.',

    'deposit_source_need_data'        => '계속하려면 유효한 소스 계정 ID 및/또는 유효한 출발지 계정 이름이 필요합니다.',
    'deposit_source_bad_data'         => '[b] ID ":id" 또는 이름 ":name"을 검색할 때 유효한 출발지 계정을 찾을 수 없습니다.',
    'deposit_dest_need_data'          => '[b] 계속하려면 유효한 목적지 계정 ID 및/또는 유효한 목적지 계정 이름이 필요합니다.',
    'deposit_dest_bad_data'           => 'ID ":id" 및 이름 ":name"(으)로 유효한 목적지 계정을 찾을 수 없습니다.',
    'deposit_dest_wrong_type'         => '제출된 목적지 계정이 올바른 유형이 아닙니다.',

    'transfer_source_need_data'       => '계속하려면 유효한 소스 계정 ID 및/또는 유효한 출발지 계정 이름이 필요합니다.',
    'transfer_source_bad_data'        => '[c] ID ":id" 또는 이름 ":name"을 검색할 때 유효한 출발지 계정을 찾을 수 없습니다.',
    'transfer_dest_need_data'         => '[c] 계속하려면 유효한 목적지 계정 ID 및/또는 유효한 목적지 계정 이름이 필요합니다.',
    'transfer_dest_bad_data'          => 'ID ":id" 및 이름 ":name"(으)로 유효한 목적지 계정을 찾을 수 없습니다.',
    'need_id_in_edit'                 => '각 분할에는 transaction_journal_id(유효한 ​​ID 또는 0) 가 있어야 합니다.',

    'ob_source_need_data'             => '계속하려면 유효한 소스 계정 ID 및/또는 유효한 출발지 계정이 필요합니다.',
    'lc_source_need_data'             => '계속하려면 유효한 출발지 계정 ID가 필요합니다.',
    'ob_dest_need_data'               => '[d] 계속하려면 유효한 목적지 계정 ID 및/또는 유효한 목적지 계정 이름이 필요합니다.',
    'ob_dest_bad_data'                => 'ID ":id" 및 이름 ":name"(으)로 유효한 목적지 계정을 찾을 수 없습니다.',
    'reconciliation_either_account'   => '조정을 제출하려면 출발지 계정 또는 목적지 계정 중 하나를 제출해야 합니다.',

    'generic_invalid_source'          => '이 계정을 출발지 계정으로 사용할 수 없습니다.',
    'generic_invalid_destination'     => '이 계정을 목적지 계정으로 사용할 수 없습니다.',

    'generic_no_source'               => '출발지 계정 정보를 제출하거나 거래 저널 ID를 제출해야 합니다.',
    'generic_no_destination'          => '목적지 계정 정보를 제출하거나 거래 저널 ID를 제출해야 합니다.',
