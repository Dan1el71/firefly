...
return [
    ...
    'transaction_journal_id'                              => 'ID del diario delle transazioni',
    'delete'                                              => 'Elimina',
    'split'                                               => 'Dividi',
    ...
    'previous_year'                                       => 'Anno precedente (:year)',
    'YTD'                                                 => 'Anno corrente',
    ...
    'expenses_by_expense_account'                         => 'Spese per conto di destinazione',
    ...
    'pref_anonymous'                                      => 'Importi nascosti',
    'pref_anonymous_help'                                 => 'Per garantire la privacy e l\'anonimato, puoi impostare Firefly III in modo che nasconda tutti gli importi. Questo non nasconderà gli importi nelle caselle di modifica, ma il resto verrà nascosto. Puoi anche attivare/disattivare questa opzione tramite la piccola icona a forma di "occhio" nella barra in alto.',
    'pref_anonymous_label'                                => 'Nascondi importi',
    ...
    'exchange_rate_instructions'                          => 'Il conto attività "@name" accetta solo transazioni in @primary_currency. Se si desidera utilizzare @foreign_currency invece, assicurarsi che l\'importo in @primary_currency sia anche conosciuto:',
    ...
    'bad_date_transaction'                                => 'Firefly III ha rilevato che hai transazioni da prima dell\'anno 1970. Correggi queste transazioni al più presto.',
    'anonymous_warning_on'                                => 'Per la tua privacy, tutti gli importi sono ora visualizzati come "zero". Attenzione: le caselle di testo possono ancora mostrare gli importi originali!',
    'anonymous_warning_off'                               => 'Gli importi saranno nuovamente visibili. Attenzione ai tuoi dintorni.',
    ...
    'webhook_response_BUDGET'                             => 'Dettagli del budget',
    ...
    'no_new_release_available'                            => 'Non è disponibile nessuna nuova versione. Sei aggiornato.',
    ...
    'applied_rule_group_selection'                        => '{0} Nessuna transazione nella tua selezione è stata modificata dalle regole del gruppo di regole ":title".[1] Una transazione nella tua selezione è stata modificata dalle regole del gruppo di regole ":title". [2,*] :count transazioni nella tua selezione sono state modificate dalle regole del gruppo di regole ":title".',
    'rule_run_after_creation'                             => 'Se si seleziona questa casella, si ottiene la possibilità di eseguire la regola dopo che è stata creata.',
    'rule_run_after_edit'                                 => 'Se si seleziona questa casella, si ottiene la possibilità di eseguire la regola dopo che è stata aggiornata.',
    ...
    'rule_trigger_not_tag_contains'                       => 'Nessun tag contiene ":trigger_value"',
    ...
    'rule_trigger_any_external_url_choice'                => 'Ha un (qualsiasi) URL esterno',
    'rule_trigger_any_external_id'                        => 'La transazione contiene un ID esterno (qualsiasi)',
    'rule_trigger_any_external_id_choice'                 => 'Ha un (qualsiasi) ID esterno',
    'rule_trigger_no_external_url_choice'                 => 'Non ha un URL esterno',
    'rule_trigger_no_external_url'                        => 'La transazione non ha URL esterno',
    'rule_trigger_no_external_id_choice'                  => 'Non ha un ID esterno',
    ...
    'rule_trigger_not_description_contains'               => 'La descrizione non contiene ":trigger_value"',
    ...
    'pref_convert_to_primary'                             => 'Visualizza gli importi nella tua valuta primaria',
    'pref_convert_to_primary_help'                        => 'Questa opzione farà sì che Firefly III tenti di visualizzare la tua valuta principale nel maggior numero possibile di posizioni, convertendo gli importi ove necessario. Questo sacrifica la precisione a favore della facilità d\'uso, poiché la conversione non è sempre esatta. Verifica che Firefly III disponga dei tassi di conversione necessari nella pagina "Tassi di cambio".',
    'pref_convert_primary_help'                           => 'Visualizza importi primari',
    ...
    'temp_administrations_introduction_edit'              => 'Attualmente, è possibile impostare solo la "valuta primaria" dell\'amministrazione finanziaria predefinita. Questa impostazione sostituisce l\'impostazione "valuta predefinita". Questa impostazione è ora collegata all\'amministrazione finanziaria e può variare a seconda dell\'amministrazione.',
    ...
    'currencies_switch_default'                           => 'Puoi cambiare la valuta principale per la tua amministrazione attuale nella pagina "Amministrazioni finanziarie".',
    'make_default_currency'                               => 'Rendila predefinita',
    'default_currency'                                    => 'predefinita',
    'primary_currency_button'                             => 'primario',
    ...
    // bills:
    'left_to_pay_active_bills'                            => 'abbonamenti attivi, previsti e non ancora pagati',
    'left_to_pay_lc'                                      => 'ancora da pagare',
    'less_than_expected'                                  => 'meno di quanto previsto',
    'more_than_expected'                                  => 'più di quanto previsto',
    ...
    'subscr_expected_x_times'                             => 'Aspettati di pagare {{amount}} {{times}} volte in questo periodo',
    'not_or_not_yet'                                      => 'No (per ora)',
    'visit_bill'                                          => 'Visita il pagamento ricorrente ":name" su Firefly III',
    'visit_bills'                                         => 'Visita gli abbonamenti su Firefly III',
    ...
    'next_expected_match'                                 => 'Prossimo pagamento previsto',
    ...
    'cannot_change_amount_reconciled'                     => 'Non è possibile modificare l\'importo o il conto(i) delle transazioni riconciliate.',
    ...
    // reports:
    'quick_link_needs_accounts'                           => 'Al fine di generare rapporti, è necessario aggiungere almeno un account asset a Firefly III.',
    ...
    'saved_so_far_total'                                  => 'Salvato finora in totale',
    'reset_history'                                       => 'reset della cronologia',
    'reset_history_confirm'                               => 'Sei sicuro di voler resettare la cronologia di questo salvadano? Questo farà sì che il grafico corrisponda di nuovo all\'importo del salvadanaio.',
    'piggy_history_reset'                                 => 'La cronologia del salvadanaio è stata resettata',
    ...
    'config_security'                                     => 'Configurazione di sicurezza',
    'config_features'                                     => 'Funzioni abilitate',
    'config_tech'                                         => 'Caratteristiche relative alle tecnologie',
    'config_external_connections'                         => 'Impostazioni sensibili alla privacy (si connette a Internet)',

    'setting_enable_exchange_rates'                       => 'Abilita i tassi di cambio',
    'setting_enable_exchange_rates_explain'               => 'Firefly III è in grado di calcolare i tassi di cambio per te.',
    'setting_use_running_balance'                         => 'Utilizzare la colonna "saldo corrente" e i dati',
    'setting_use_running_balance_explain'                 => 'Firefly III può calcolare il saldo corrente e visualizzarlo in vari punti. È ancora in fase sperimentale, quindi è disabilitato di default. Potrebbe essere necessario riavviare il container o eseguire manualmente il comando iniziale (vedere la documentazione).',
    'setting_enable_external_map'                         => 'Utilizzare un servizio di mappe esterno',
    'setting_enable_external_map_explain'                 => 'Firefly III utilizza un servizio esterno per visualizzare le posizioni. Va bene?',
    'setting_enable_external_rates'                       => 'Scarica i tassi di cambio dal web',
    'setting_enable_external_rates_explain'               => 'Firefly III può scaricare i tassi di cambio per le valute integrate. Per funzionare, è necessario il cron job.',
    'setting_allow_webhooks'                              => 'Consenti webhooks',
    'setting_allow_webhooks_explain'                      => 'Consentire a Firefly III di attivare webhook?',
    'setting_valid_url_protocols'                         => 'Protocolli URL consentiti',
    'setting_valid_url_protocols_explain'                 => 'Firefly III consente solo URL con protocolli standard come https e ftp ecc. Se sei un tecnico esperto, potresti voler consentire anche altri protocolli.',
    'setting_enable_batch_processing'                     => 'Abilita l\'elaborazione batch',
    'setting_enable_batch_processing_explain'             => 'L\'elaborazione in batch è una caratteristica relativamente nuova di Firefly III che consente di elaborare una serie di nuove transazioni (aka a batch) quando la transazione finale viene inviata, e non durante la presentazione di ogni singolo ingresso. Questo rende l\'importazione dei dati più veloce, ma salta anche le regole fino alla fine. È una funzione sperimentale disabilitata per impostazione predefinita.',
    ...
    'recurring_ndom_skip'                                 => 'Ogni :skip(st/nd/rd/th) mese in :dayOfMonth(st/nd/rd/th) :weekday',
    ...
    // audit log entries
    'incomplete_ale'                                      => 'Non tutti gli eventi sono registrati come voci di audit.',
    ...
    'ale_action_update_foreign_amount'                    => 'Importo estero aggiornato',
