...
return [
    ...
    'no_new_release_available'                            => 'Δεν διατίθεται νεότερη έκδοση. Χρησιμοποιείτε την πιο πρόσφατη.',
    ...
    'setting_enable_batch_processing'                     => 'Ενεργοποίηση μαζικής επεξεργασίας',
    'setting_enable_batch_processing_explain'             => 'Η μαζική επεξεργασία είναι ένα σχετικά νέο χαρακτηριστικό του Firefly III που επιτρέπει την επεξεργασία ενός συνόλου νέων συναλλαγών (δέσμη) όταν υποβάλλεται η τελική συναλλαγή, και όχι κατά την υποβολή κάθε μεμονωμένης καταχώρισης. Αυτό επιταχύνει την εισαγωγή δεδομένων, αλλά και παραλείπει τους κανόνες μέχρι το τέλος. Αποτελεί μια πειραματική λειτουργία, γι\' αυτό και είναι απενεργοποιημένη από προεπιλογή.',
    ...
    'ale_action_update_foreign_amount'                    => 'Ενημερωμένο ποσό σε ξένο νόμισμα',
