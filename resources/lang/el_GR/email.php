...
return [
    ...
    'unknown_user_body'                          => 'Ένας άγνωστος χρήστης (`:ip`) προσπάθησε να συνδεθεί στο Firefly III. Η διεύθυνση ηλεκτρονικού ταχυδρομείου που χρησιμοποίησε ήταν `:address`.',
    'unknown_user_message'                       => 'Η διεύθυνση ηλεκτρονικού ταχυδρομείου που χρησιμοποίησε (`:ip`) ήταν `:address`.',

    // known user login attempt
    'failed_login_subject'                       => 'Firefly III detected a failed login attempt',
    'failed_login_body'                          => 'Το Firefly III εντόπισε ότι κάποιος (εσείς;) δεν μπόρεσε να συνδεθεί με το λογαριασμό σας `:email`. Επιβεβαιώστε ότι ήσασταν ο ίδιος.',
    'failed_login_message'                       => 'Εντοπίστηκε μια αποτυχημένη προσπάθεια σύνδεσης (`:ip`) στον λογαριασμό σας `:email` στο Firefly III.',
    ...
    'used_backup_code_intro'                     => 'Εσείς (:email) χρησιμοποιήσατε έναν εφεδρικό κωδικό για τη σύνδεση στο Firefly III. Τώρα έχετε έναν εφεδρικό κωδικό λιγότερο για να συνδεθείτε. Παρακαλώ αφαιρέστε τον από τη λίστα σας.',
