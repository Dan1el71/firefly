...
return [
    ...
    'no_new_release_available'                            => 'Il n\'y a pas de nouvelle version disponible. Vous êtes à jour.',
    ...
    'applied_rule_group_selection'                        => '{0} Aucune opération dans votre sélection n\'a été modifiée par les règles du groupe de règles ":title".|[1] Une opération dans votre sélection a été modifiée par les règles du groupe de règles ":title".|[2,*] :count opérations dans votre sélection ont été modifiées par les règles du groupe de règles ":title".',
    ...
    'setting_enable_batch_processing'                     => 'Activer le traitement par lots',
    'setting_enable_batch_processing_explain'             => 'Le traitement par lots est une fonctionnalité relativement récente de Firefly III qui permet de traiter un ensemble de nouvelles opérations (un lot) lorsque la dernière opération est envoyée, et non lors de l\'envoi de chaque opération. Cela rend l\'importation de données plus rapide, mais exécute les règles uniquement à la fin. C\'est une fonctionnalité expérimentale désactivée par défaut.',
    ...
    'ale_action_update_foreign_amount'                    => 'Montant en devise étrangère mis à jour',
