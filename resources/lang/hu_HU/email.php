...
return [
    ...
    'admin_test_message'                         => 'Ez egy tesztüzenet a Firefly III példányból a „:channel” csatornán keresztül.',

    // invite
    'invitation_created_subject'                 => 'Meghívó elkészült',
    'invitation_created_body'                    => '„:email” admin felhasználó létrehozott egy felhasználói meghívót, amelyet bárki használhat, aki „:invitee” e-mail cím mögött található. A meghívó 48 óráig lesz érvényes.',
    'invite_user_subject'                        => 'Meghívást kaptál egy Firefly III felhasználói fiók létrehozásához.',
    'invitation_introduction'                    => 'Meghívást kapott egy Firefly III fiók létrehozására **:host** oldalon. A Firefly III egy személyes, saját tárhelyen üzemeltetett, privát személyi pénzügyi menedzser. Minden menő srác ezt használja.',
    'invitation_invited_by'                      => '„:admin” hívta meg, és ezt a meghívót „:invitee” kapta. Ez te vagy, ugye?',
    'invitation_url'                             => 'A meghívó 48 óráig érvényes, és a [Firefly III](:url) oldalon szörfözve váltható be. Jó szórakozást!',

    // new IP
    'login_from_new_ip'                          => 'Új bejelentkezés a Firefly III-ba',
    'slack_login_from_new_ip'                    => 'Új bejelentkezés a Firefly III-ba :ip (:host) IP címről',
    ...
    'ip_address'                                 => 'IP cím',
    'host_name'                                  => 'Kiszolgáló',
    'date_time'                                  => 'Dátum és idő',
    'user_agent'                                 => 'Böngésző',

    // access token created
    'access_token_created_subject'               => 'Egy új hozzáférési token lett létrehozva',
    ...
    'unknown_user_subject'                       => 'Egy ismeretlen felhasználó próbált bejelentkezni',
    ...
    'failed_login_subject'                       => 'A Firefly III egy sikertelen bejelentkezési kísérletet detektált',
    ...
    // registered
    'registered_subject'                         => 'Üdvözöli a Firefly III!',
    'registered_subject_admin'                   => 'Egy új felhasználó regisztrált',
    'admin_new_user_registered'                  => 'Egy új felhasználó regisztrált. A **:email** felhasználó ezt a felhasználó azonosítót kapta: #:id.',
    'registered_welcome'                         => 'Welcome to [Firefly III](:address). Your registration has made it, and this email is here to confirm it. Yay!',
    'registered_pw'                              => 'If you have forgotten your password already, please reset it using [the password reset tool](:address/password/reset).',
    'registered_help'                            => 'There is a help-icon in the top right corner of each page. If you need help, click it!',
    'registered_closing'                         => 'Jó szórakozást!',
    'registered_firefly_iii_link'                => 'Firefly III:',
    'registered_pw_reset_link'                   => 'Password reset:',
    'registered_doc_link'                        => 'Dokumentáció:',

    // new version
    'new_version_email_subject'                  => 'Új Firefly III verzió érhető el',
