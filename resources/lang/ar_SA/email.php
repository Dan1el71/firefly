...
return [
    ...
    'greeting'                                   => 'أهلا بك،',
    'closing'                                    => 'بيب بوب،',
    'signature'                                  => 'روبوت بريد Firefly III',
    'footer_ps'                                  => 'ملاحظة: تم إرسال هذه الرسالة بسبب طلب من عنوان الـ IP التالي: :ipAddress.',

    // admin test
    'admin_test_subject'                         => 'رسالة اختبار من تثبيت Firefly III',
    'admin_test_body'                            => 'هذه رسالة اختبار من Firefly III الخاص بك. تم إرسالها إلى :email.',
    'admin_test_message'                         => 'هذه رسالة اختبار من Firefly III الخاص بك. تم إرسالها إلى :channel.',

    // invite
    'invitation_created_subject'                 => 'تم إنشاء دعوة',
    'invitation_created_body'                    => 'قام المستخدم المشرف ":email" بإنشاء دعوة يمكن استخدامها من قبل صاحب عنوان البريد الإلكتروني ":invitee". ستكون الدعوة صالحة لمدة ٤٨ ساعة.',
    'invite_user_subject'                        => 'لقد تمت دعوتك لإنشاء حساب Firefly III.',
    'invitation_introduction'                    => 'تمت دعوتك لإنشاء حساب على Firefly III في **:host**.
Firefly III هو مدير مالي شخصي، خاص، ومُستضاف ذاتيًا. جميع الأشخاص الرائعين يستخدمونه.',
    'invitation_invited_by'                      => 'لقد تم دعوتك من قبل ":admin" وقد تم إرسال هذه الدعوة إلى ":invitee". هذا أنت، أليس كذلك؟',
    'invitation_url'                             => 'الدعوة صالحة لمدة ٤٨ ساعة ويمكن استخدامها من خلال زيارة [Firefly III](:url). استمتع!',

    // new IP
    'login_from_new_ip'                          => 'تسجيل دخول جديد على Firefly III',
    'slack_login_from_new_ip'                    => 'تسجيل دخول جديد على Firefly III من IP :ip (:host)',
    'new_ip_body'                                => 'اكتشف Firefly III تسجيل دخول جديدًا إلى حسابك من عنوان IP غير معروف. إذا لم تقم بتسجيل الدخول من عنوان IP أدناه، أو إذا مرّ أكثر من ستة أشهر على ذلك، فسيقوم Firefly III بتحذيرك.',
    'new_ip_warning'                             => 'إذا كنت تتعرف على عنوان الـ IP هذا أو عملية تسجيل الدخول، يمكنك تجاهل هذه الرسالة. إذا لم تقم بتسجيل الدخول، أو لم تكن لديك فكرة عن هذا الأمر، فتحقق من أمان كلمة مرورك، وقم بتغييرها، وسجل الخروج من جميع الجلسات الأخرى. للقيام بذلك، انتقل إلى صفحة ملفك الشخصي. وبالطبع، أنت فعّلت المصادقة الثنائية بالفعل، أليس كذلك؟ ابقَ آمنًا',
    ...
    'failed_login_warning'                       => 'إذا كنت تتعرف على عنوان الـ IP هذا أو محاولة تسجيل الدخول، يمكنك تجاهل هذه الرسالة. إذا لم تحاول تسجيل الدخول، أو لم تكن لديك فكرة عن هذا الأمر، فتحقق من أمان كلمة مرورك، وقم بتغييرها، وسجل الخروج من جميع الجلسات الأخرى. للقيام بذلك، انتقل إلى صفحة ملفك الشخصي. وبالطبع، لقد فعلت المصادقة الثنائية بالفعل، أليس كذلك؟ ابقَ آمنًا!',
