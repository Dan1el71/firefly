...
return [
    // index
    'index_intro'                                             => 'Добро пожаловать на стартовую страницу Firefly III. Пожалуйста, найдите время, чтобы ознакомиться с этим кратким введением о возможностях Firefly III.',
    ...
    'index_sidebar-toggle'                                    => 'Для создания новых транзакций, счётов или других элементов, используйте меню под этим значком.',
