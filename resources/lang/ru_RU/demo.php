...
return [
    ...
    'profile-index'          => 'Обратите внимание, что все данные на демонстрационном сайте очищаются каждые 4 часа. Стандартные агенты (curl, Postman, wget) блокируются. Ваш доступ к сайту может быть прекращён в любой момент. Это происходит автоматически и не является ошибкой.',
];
