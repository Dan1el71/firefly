...
return [
    ...
    'check_back'              => 'Firefly III отключён для необходимого обслуживания. Пожалуйста, зайдите через секунду. Если вы видите это сообщение на демо-сайте, просто подождите несколько минут. База данных обновляется каждые несколько часов.',
