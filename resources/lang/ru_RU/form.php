...
return [
    ...
    'bill_areYouSure'             => 'Вы действительно хотите удалить подписку с именем ":name"?',
    ...
    'bill_keep_transactions'      => 'Единственная транзакция, связанная с данной подпиской, не будет удалена.|Все :count транзакции, связанные с этой подпиской, будут сохранены.',
    ...
    'pushover_app_token'          => 'Pushover токен приложения',
    'pushover_user_token'         => 'Pushover токен пользователя',
    'ntfy_server'                 => 'Ntfy сервер',
    'ntfy_topic'                  => 'Ntfy заголовок',
    'ntfy_auth'                   => 'Включена аутентификация Ntfy',
    'ntfy_user'                   => 'Ntfy имя пользователя',
    'ntfy_pass'                   => 'Ntfy пароль',
];
